...
//     const navLinks = document.querySelectorAll('.nav-links a'); another way to write the above code
...
// }
    ...
    function smoothScroll(e) {
        ...
        e.preventDefault();
        const targetId = e.target.getAttribute('href').substring(1);//substring starts from index 1, and removes the # from the href
